...
<div class="flex items-center justify-center min-h-screen bg-dots-darker bg-center bg-gray-100 selection:bg-red-500 selection:text-white">
    <div class="text-center">
        @if (Route::has('login'))
            @auth
                <button href="{{ url('/dashboard') }}" class="font-semibold text-white bg-blue-700 hover:bg-blue-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 px-4 py-2 rounded-lg">Dashboard</button>
            @else
                <button onclick="window.location.href='{{ route('login') }}'" class="mt-4 font-semibold text-white bg-blue-700 hover:bg-blue-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 px-4 py-2 rounded-lg">Log in</button>

                @if (Route::has('register'))
                    <button onclick="window.location.href='{{ route('register') }}'" class="mt-4 ml-4 font-semibold text-white bg-blue-700 hover:bg-blue-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 px-4 py-2 rounded-lg">Register</button>
                @endif
            @endauth
        @endif
    </div>
